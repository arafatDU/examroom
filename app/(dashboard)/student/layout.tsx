...
import { LayoutDashboard, History, LogOut, Search, BookOpen, Menu, X } from "lucide-react";
import { cn } from "@/lib/utils";
import { useState } from "react";

const sidebarItems = [
  { name: "Dashboard",   href: "/student",         icon: LayoutDashboard },
  { name: "My Results",  href: "/student/results", icon: History },
  { name: "Find Rooms",  href: "/student/explore", icon: Search },
];
        ...
        <div className="p-6 border-b border-slate-100">
          <Link href="/student" className="flex items-center gap-2.5 group">
            ...
            <div>
              ...
              <span className="text-xs font-semibold text-indigo-500 uppercase tracking-wider">Student Portal</span>
            </div>
          </Link>
        </div>
