...
import { Users, BookOpen, BarChart3, LogOut, LayoutDashboard, Menu, X, ShieldAlert } from "lucide-react";
    ...
    <div className="flex h-screen overflow-hidden" style={{ background: "#f8f9ff" }}>
      ...
      <aside className="hidden lg:flex w-72 flex-col border-r border-slate-200 bg-white flex-shrink-0">
        ...
        <div className="p-4 border-t border-slate-100">
          <div className="flex items-center gap-3 px-2 py-2 mb-2">
            <div className="w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold text-white flex-shrink-0 bg-slate-900">
              {initials}
            </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-slate-200 flex-shrink-0">
          ...
          <div className="w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold text-white bg-slate-900" style={{ background: "#0f172a" }}>
            {initials}
          </div>
        </header>
